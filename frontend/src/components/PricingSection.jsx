    ...
    <section id="pricing" className="py-24 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-[1400px] relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 md:p-10 hover:shadow-2xl transition-all duration-300 hover:border-gray-300">
            ...
            <form onSubmit={handleWaitlistSignup}>
              <input 
                ...
                className="w-full px-5 py-4 border-2 border-gray-200 rounded-xl mb-4 text-lg focus:border-purple-400 focus:outline-none transition-colors"
                disabled={loading}
              />
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center hover:bg-gray-800 transition-all cursor-pointer hover:shadow-lg active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : 'Join Free Waitlist'}
              </button>
          ...
          <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 border-2 border-purple-500 rounded-3xl p-8 md:p-10 hover:shadow-2xl transition-all duration-300 relative overflow-hidden hover:scale-[1.01]">
            ...
            <div className="text-center mb-8 relative">
              ...
              <div className="mb-3">
                <span className="text-6xl font-extrabold text-white">₹249</span>
                <span className="text-xl text-purple-200 ml-1">/month</span>
              </div>
              <p className="text-purple-300 line-through text-lg mb-3">
                ₹499/month
              </p>
            ...
            <ul className="space-y-4 mb-10 relative">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  ...
                  <span className={`text-lg text-white ${feature.bold ? 'font-bold' : ''}`}>
                    {feature.text}
                  </span>
                </li>
              ))}
            ...
            <button 
              ...
              className="w-full bg-white text-purple-700 py-4.5 rounded-xl font-bold text-xl hover:bg-purple-50 transition-all flex items-center justify-center gap-2.5 cursor-pointer shadow-xl hover:shadow-2xl relative active:scale-[0.98]"
            >
        ...
        <div className="mt-20 max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-3xl p-10 md:p-12">
            <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-green-200">
